...
phpdeps=( "php" "php-mysql" "php-mcrypt" "php-common" "php-xml" "php-gd" "libapache2-mod-php" "php-mbstring" "php-curl" )
phpVersionedDeps=( "php$VERSION" "php$VERSION-mysql" "php$VERSION-mcrypt" "php$VERSION-common" "php$VERSION-xml" "php$VERSION-gd" "libapache2-mod-php$VERSION" "php$VERSION-mbstring" "php$VERSION-curl" )
